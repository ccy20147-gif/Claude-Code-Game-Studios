...
Route `empty` to `$ue5-conceive-game`, `narrative` to `$ue5-adapt-story`, and design or implementation inputs to `$ue5-ingest-project`. Use `standard` unless the user explicitly selects an isolated prototype, maintenance, or hotfix workflow.
