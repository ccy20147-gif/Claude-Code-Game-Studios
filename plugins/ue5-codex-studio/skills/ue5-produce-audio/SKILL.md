...
Read the audio bible and work item. Track source, license or consent, contributor, version, technical QC, loudness, and delivery file for every asset. Preserve `line_id -> locale -> approved translation -> take -> cue_id -> UE asset` links; a changed line or translation becomes stale through `$ue5-change-design`.
