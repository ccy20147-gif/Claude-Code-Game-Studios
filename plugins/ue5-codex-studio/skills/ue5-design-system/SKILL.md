---
name: ue5-design-system
description: Create or revise a testable UE5 game-system specification from an accepted baseline. Use for mechanics, economy, combat, progression, interaction, UI state, or other game rules.
---
