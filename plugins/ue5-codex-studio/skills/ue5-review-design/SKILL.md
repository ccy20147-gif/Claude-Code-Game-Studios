---
name: ue5-review-design
description: Review UE5 game design, narrative, systems, scope, and cross-discipline consistency against an accepted baseline. Use for design reviews, GDD reviews, scope checks, and pre-production or release gates.
---
