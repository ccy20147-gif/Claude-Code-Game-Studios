---
name: ue5-hotfix-game
description: Triage, implement, validate, and document a UE5 hotfix from a deployed build with rollback readiness. Use only for a live issue against a released build.
---
