---
name: godot-execute-work
description: Implement and complete an approved Godot 4 work item with scoped changes, capability preflight, review, and normalized evidence. Use after a work item is READY and its baseline revision is current.
---
