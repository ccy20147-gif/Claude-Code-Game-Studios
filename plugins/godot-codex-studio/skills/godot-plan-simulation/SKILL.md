...
Only promise determinism for the owned subsystem's seeded PRNG and logged state. Explicitly exclude Godot physics, rendering, and other nondeterministic engine components. Couple the plan to `$godot-plan-persistence` and require replay or declared tolerance evidence before acceptance.
