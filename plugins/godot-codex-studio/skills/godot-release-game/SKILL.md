---
name: godot-release-game
description: Prepare, validate, approve, and document a Godot 4 game release with immutable build identity, platform evidence, player communications, and rollback readiness. Use for milestone, beta, early-access, or public release candidates.
---

# Release A Godot 4 Game
