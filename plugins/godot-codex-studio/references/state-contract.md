...
Treat YAML under `.godot-codex-studio/`, `intake/`, `design/`, and `production/` as workflow truth. Markdown is a source or view and cannot override structured records.
